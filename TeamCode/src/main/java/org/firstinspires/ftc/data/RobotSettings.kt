package org.firstinspires.ftc.data
...
class RobotSettings private constructor(context: Context) {
    ...
    companion object {
        @Volatile
        private var INSTANCE: RobotSettings? = null

        fun getInstance(context: Context): RobotSettings {
            return INSTANCE ?: synchronized(this) {
                INSTANCE?.let {
                    return it
                }

                val instance = RobotSettings(context)
                INSTANCE = instance
                instance
            }
        }
